...
from transfer.models import Category, Comment
...
def reservations(request):
    ...
    return render(request, 'user_reserv.html', context)
...
def reservationdetails(request, id):
    ...
    reservationsitems = reservTransfer.objects.filter(reservation_id=id)
    context = {
        'category': category,
        'reservation': reservation,
        'reservationsitems': reservationsitems
    }
    return render(request, 'user_reserv_detail.html', context)
